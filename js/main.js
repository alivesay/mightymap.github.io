(function() {
  ...
  window.index = Backbone.View.extend({
    ...
    // Example stuff showing how to re-render only parts of the page on model change.
  ...
  window.mapMaker = Backbone.View.extend({
  ...
  window.mapViewer = Backbone.View.extend();
  ...
  window.router = Backbone.Router.extend({
    ...
    index: function() {
      this.index = new window.index();
    },
 
    mapMaker: function() {
      this.mapMaker = new window.mapMaker()
    }
